...
public class VoteController {
    ...
    @GetMapping("/{id}")
    public VoteEntity getOne(@PathVariable Integer id) { return service.getById(id); }

    @PostMapping
    public VoteEntity create(@RequestBody VoteEntity entity) { return service.add(entity); }

    @PutMapping("/{id}")
    public VoteEntity update(@PathVariable Integer id, @RequestBody VoteEntity entity) {
